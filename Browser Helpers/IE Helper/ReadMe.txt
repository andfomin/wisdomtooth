========================================================================
    ACTIVE TEMPLATE LIBRARY : IEHelper Project Overview
========================================================================

AppWizard has created this IEHelper project for you to use as the starting point for
...
IEHelper.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (IEHelper.h)
        GUID definitions                                (IEHelper_i.c)
        A type library                                  (IEHelper.tlb)
        Marshaling code                                 (IEHelper_p.c and dlldata.c)

IEHelper.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in IEHelper.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named IEHelper.pch and a precompiled types file named StdAfx.obj.
...
IEHelperps.vcxproj
	...
	dlldata.c, IEHelper_i.c and IEHelper_p.c which are required
	to build the proxy/stub DLL.

IEHelperps.vcxproj.filters
